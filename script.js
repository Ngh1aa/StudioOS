...
/* Quiet Editorial Operations: Projects prioritizes whitespace, consistent controls, and unobstructed portfolio imagery. */
...
function projectsPage() {
  return `<div class="page-shell-page projects-page"><div class="page-intro-row">${pageHeader("02 / Portfolio", "Projects", "A clear view of every brief, milestone and next decision.", `<button class="primary-button" id="pageNewProjectButton" type="button"><span data-icon="plus"></span> New project</button>`)}</div><section class="project-filter-rail project-controls" aria-label="Project controls"><label class="project-search-field toolbar-search"><span data-icon="search"></span><span class="sr-only">Search projects</span><input id="projectFilterInput" type="search" placeholder="Search projects" /></label><div class="project-filter-cluster project-status-cluster filter-group" role="group" aria-labelledby="projectStatusLabel"><span class="filter-group-label" id="projectStatusLabel">Status</span><div class="filter-chips"><button class="filter-chip filter-tag active" type="button" aria-pressed="true" data-project-filter="All">All <em>04</em></button><button class="filter-chip filter-tag" type="button" aria-pressed="false" data-project-filter="In review">In review <em>01</em></button><button class="filter-chip filter-tag" type="button" aria-pressed="false" data-project-filter="On track">On track <em>02</em></button><button class="filter-chip filter-tag" type="button" aria-pressed="false" data-project-filter="Not started">Not started <em>01</em></button></div></div><div class="project-filter-cluster project-type-cluster"><div class="taxonomy-heading"><span class="taxonomy-label">Type</span><span class="taxonomy-hint">Filter by project type</span></div><div class="taxonomy-scroller" role="group" aria-label="Filter projects by type"><button class="taxonomy-chip filter-tag active" type="button" aria-pressed="true" data-project-view="All">All work <em>04</em></button><button class="taxonomy-chip filter-tag" type="button" aria-pressed="false" data-project-view="Brand">Brand <em>01</em></button><button class="taxonomy-chip filter-tag" type="button" aria-pressed="false" data-project-view="Digital">Digital <em>01</em></button><button class="taxonomy-chip filter-tag" type="button" aria-pressed="false" data-project-view="Campaign">Campaign <em>01</em></button><button class="taxonomy-chip filter-tag" type="button" aria-pressed="false" data-project-view="Research">Research <em>01</em></button></div></div><button class="ghost-button project-sort-control" type="button" data-action="sort-projects" aria-label="Sort projects"><span class="sort-label">Sort</span> <span data-icon="sliders"></span></button></section><section class="project-metrics" aria-label="Project summary"><article class="project-metric"><small>Total value</small><strong>04</strong><span>active projects</span></article><article class="project-metric"><small>Moving well</small><strong>03</strong><span>on schedule</span></article><article class="project-metric project-metric-attention"><small>Needs attention</small><strong>01</strong><span>awaiting your eye</span></article></section><section class="page-section-heading"><div><div class="section-kicker">${currentProjectView === "All" ? "All work" : currentProjectView} / ${currentProjectFilter}</div><h2>Project index</h2></div><span class="page-count" id="projectsPageCount" aria-live="polite">${projects.length} results</span></section><div class="project-grid projects-page-grid" id="projectsPageGrid"></div></div>`;
}
...
function renderProjects(query = "") {
  ...
  button.innerHTML = `${icon("arrow-up-right")}<span class="show-all-label">${showAllProjects ? "Show less" : "View all projects"}</span>`;
