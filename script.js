...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.querySelectorAll("[data-action]").forEach((button) => button.addEventListener("click", () => { const action = button.dataset.action; if (["workspace","help","focus-options","activity-options","activity","comment","profile-menu"].includes(action)) toast(action === "help" ? "Need a hand? Help center is coming soon." : action === "comment" ? "Comment composer is coming soon." : action === "profile-menu" ? "Account menu is coming soon." : "This workspace action is coming soon."); }));
