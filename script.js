...
const projects = [
  { id:"lumen-house", name:"Lumen House", type:"Brand system", status:"In review", tone:"review", progress:78, due:"Today", dueTone:"urgent", owner:"Maya Chen", members:["MC","JT","AN"], cover:"./assets/studioos-project-architecture-refresh.png" },
  { id:"common-ground", name:"Common Ground", type:"Digital experience", status:"On track", tone:"progress", progress:46, due:"18 Aug", dueTone:"normal", owner:"Noah Williams", members:["NW","LC","OR"], cover:"./assets/studioos-project-material-refresh.png" },
  { id:"northstar", name:"Northstar / Q3", type:"Campaign launch", status:"On track", tone:"progress", progress:24, due:"02 Sep", dueTone:"normal", owner:"Jules Tran", members:["JT","MC"], cover:"./assets/studioos-project-motion-refresh.png" },
  { id:"field-notes", name:"Field Notes", type:"Research sprint", status:"Not started", tone:"quiet", progress:0, due:"09 Sep", dueTone:"quiet", owner:"Anika Rao", members:["AR","NW"], cover:"./assets/studioos-project-field-notes-refresh.png" },
];
